    ...
    <>
      <div className="flex-col md:flex">
        ...
        <div className="flex-1 space-y-4 p-8 pt-6">
          <div className="flex-row sm:flex items-center justify-between space-y-4 md:space-y-2">
          ...
          <Tabs defaultValue="overview" className="space-y-4">
            <TabsList className='mx-auto block md:mx-0 md:w-fit'>
              ...
              <div className="space-y-4 md:space-y-0 md:grid md:gap-4 md:grid-cols-2 lg:grid-cols-7">
                ...
                <Card className="md:col-span-3">
                  <CardHeader>
                    ...
                    <CardDescription>
                      You had 356 new subscriptions this month
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <RecentSubscriptions />
